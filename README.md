...
├── src/
│   ├── components/          # 공통 컴포넌트
│   │   ├── SessionWatcher.jsx   # 세션 자동 종료 감시
│   │   └── TestButton.jsx       # 개발용 테스트 버튼
│   ├── pages/              # 페이지 컴포넌트
│   │   ├── Home.jsx            # 메인 홈 화면
│   │   ├── MainMenu.jsx        # 메뉴 화면
│   │   ├── Unlock.jsx          # 디바이스 꺼내기 화면
│   │   ├── Contacts.jsx        # 연락처 관리
│   │   ├── SettingsMain.jsx    # 설정 메인
│   │   ├── SettingDetails.jsx  # 설정 상세
│   │   ├── IncomingCall.jsx    # 수신 전화
│   │   ├── OutgoingCall.jsx    # 발신 전화
│   │   ├── Call.jsx            # 통화 중
│   │   ├── IncomingAlarm.jsx   # 알람 화면
│   │   ├── Simulation.jsx      # 시뮬레이션 모드
│   │   ├── Outing.jsx          # 외출 모드
│   │   └── Warning.jsx         # 경고 화면
│   ├── utils/              # 유틸리티 함수
│   │   └── vaultStorage.js     # LocalStorage 관리
│   ├── App.jsx             # 앱 라우팅 설정
│   ├── main.jsx            # 앱 진입점
│   └── index.css           # 전역 스타일
├── public/                 # 정적 파일
